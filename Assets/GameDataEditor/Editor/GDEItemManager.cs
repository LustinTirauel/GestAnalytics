...
namespace GameDataEditor
{
    public class GDEItemManager
    {
        ...
        static Dictionary<string, List<string>> ItemListBySchema
        {
        ...
        static List<string> FieldKeysOfType(string key, string fieldType, Dictionary<string, Dictionary<string, object>> dict, bool onlyLists = false)
        {
        ...
        static List<string> CustomFieldKeys(string key, Dictionary<string, Dictionary<string, object>> dict, bool onlyLists = false)
        {
            List<string> fieldKeys = new List<string>();
            Dictionary<string, object> data;
            string fieldName;
        ...
        static List<string> ListFieldKeysOfType(string key, string fieldType, Dictionary<string, Dictionary<string, object>> dict)
        {
            return FieldKeysOfType(key, fieldType, dict, true);
        }

        static List<string> ListCustomFieldKeys(string key, Dictionary<string, Dictionary<string, object>> dict)
        {
        ...
        static bool FileChangedOnDisk(string filePath, string cachedMD5)
        {
        ...
        public static bool AddBasicFieldToSchema(BasicFieldType type, string schemaKey, Dictionary<string, object> schemaData, string newFieldName, out string error, bool isList = false, object defaultValue = null)
        {
            ...
            if (result)
            {
                if (isList)
                {
                    ...
                    schemaData.Add(string.Format(GDMConstants.MetaDataFormat, GDMConstants.IsListPrefix, newFieldName), true);
                }
                else
                {
        ...
        static void AddBasicFieldToItems(BasicFieldType type, string schemaKey, string newFieldName, bool isList, object defaultValue)
        {
            ...
            foreach(string itemKey in itemKeys)
            {
                if (AllItems.TryGetValue(itemKey, out itemData))
                {
                    if (isList)
                    {
                        ...
                        itemData.Add(string.Format(GDMConstants.MetaDataFormat, GDMConstants.IsListPrefix, newFieldName), true);
                    }
                    else
                    {
        ...
        static void AddCustomFieldToItems(string customType, string schemaKey, string newFieldName, bool isList)
        {
            List<string> itemKeys = GetItemsOfSchemaType(schemaKey);
            Dictionary<string, object> itemData;
